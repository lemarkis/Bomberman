...
void PauseState::enter()
{
    ...
    OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "BackToGameBtn", "Reprendre", 250);
    OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "BackToMenuBtn", "Revenir au menu", 250);
    OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "ExitBtn", "Quitter", 250);
...
void PauseState::buttonHit(OgreBites::Button *button)
{
    ...
    {
        OgreFramework::getSingletonPtr()->m_pTrayMgr->showYesNoDialog("Sur?", "Voulez vous reellement quitter?");
